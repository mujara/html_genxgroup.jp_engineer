...
require([
  "swiper-bundle.min",			//スライダーJS
	...
	//利用者様のご感想　スライダー
  const mySwiperMovie = new Swiper('.homeTestimonalBox__inner .swiper', {
  	slidesPerView: 'auto', // コンテナ内に表示させるスライド数（CSSでサイズ指定する場合は 'auto'）
	  //centeredSlides: true, // アクティブなスライドを中央に配置する
	  spaceBetween: 16,
    grabCursor: true,
    pagination: {
      el: '.homeTestimonalBox__inner .card01 .swiper-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.homeTestimonalBox__inner .card01 .swiper-button-next',
      prevEl: '.homeTestimonalBox__inner .card01 .swiper-button-prev',
    },
    breakpoints: {
      600: {
	      slidesPerView: 1,
